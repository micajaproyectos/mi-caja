        ...
        <div className="fixed inset-0 z-[60] flex items-center justify-center p-4 bg-black/70 backdrop-blur-sm">
          ...
          >
            <div
              ...
              style={{ backgroundColor: 'rgba(74, 222, 128, 0.15)', borderBottom: '1px solid rgba(255, 255, 255, 0.1)' }}
            >
              <h2 className="text-xl font-bold text-white drop-shadow-lg">Términos y Condiciones</h2>
              <button
            ...
            <div
              ...
              style={{ scrollbarWidth: 'thin', scrollbarColor: 'rgba(74, 222, 128, 0.5) rgba(0, 0, 0, 0.2)' }}
            >
              <div className="text-gray-200 space-y-5 text-sm leading-relaxed">
                ...
                <div>
                  <h3 className="text-white font-bold text-base mb-2 flex items-center gap-2">
                    <span className="text-green-400">1.</span>Responsabilidad del Titular
                  </h3>
                ...
                <div>
                  <h3 className="text-white font-bold text-base mb-2 flex items-center gap-2">
                    <span className="text-green-400">2.</span>Cumplimiento Tributario
                  </h3>
                ...
                <div>
                  <h3 className="text-white font-bold text-base mb-2 flex items-center gap-2">
                    <span className="text-green-400">3.</span>Uso del Sistema
                  </h3>
                  <p className="text-gray-300 pl-6">
                ...
                <div>
                  <h3 className="text-white font-bold text-base mb-2 flex items-center gap-2">
                    <span className="text-green-400">4.</span>Exactitud de la Información
                  </h3>
                  <p className="text-gray-300 pl-6 mb-2">Mi Caja no se hace responsable por errores derivados de:</p>
                ...
                <div>
                  <h3 className="text-white font-bold text-base mb-2 flex items-center gap-2">
                    <span className="text-green-400">5.</span>Accesos y Seguridad
                  </h3>
                  <p className="text-gray-300 pl-6">
                ...
                <div>
                  <h3 className="text-white font-bold text-base mb-2 flex items-center gap-2">
                    <span className="text-green-400">6.</span>Limitación de Responsabilidad
                  </h3>
                  <p className="text-gray-300 pl-6">
                ...
                <div className="pt-4 border-t border-white/10">
                  <h3 className="text-white font-bold text-base mb-2 flex items-center gap-2">
                    <span className="text-green-400">7.</span>Aceptación
                  </h3>
            ...
            <div
              ...
              style={{ backgroundColor: 'rgba(26, 61, 26, 0.6)', borderTop: '1px solid rgba(255, 255, 255, 0.1)' }}
            >
              <button
                onClick={() => setMostrarTerminos(false)}
                className="px-6 py-2 bg-green-500 hover:bg-green-400 text-white font-semibold rounded-xl transition-all duration-200"
              >
                Entendido
              </button>
            </div>
