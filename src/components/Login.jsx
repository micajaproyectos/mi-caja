...
function Login() {
  ...
  const [tooltipWa, setTooltipWa] = useState(false);
  ...
  return (
    <div className="min-h-screen relative overflow-hidden" style={{ backgroundColor: '#1a3d1a' }}>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div>
              ...
              <h1 className="text-4xl lg:text-5xl font-extrabold text-gray-900 leading-tight mb-5">
                Ordena tu negocio <span style={{ color: '#16a34a' }}>simple y barato.</span>
              </h1>

              <p className="text-lg text-gray-500 mb-8 max-w-lg">
                Ventas, stock, insumos, pedidos, comandas en un solo lugar. Simple, rápido, barato, sin complicaciones y sin instalación.
              </p>

              <div className="mb-10" style={{ display: 'inline-block', position: 'relative' }}>
                {tooltipWa && (
                  <div style={{
                    position: 'absolute',
                    bottom: 'calc(100% + 8px)',
                ...
                <a
                  ...
                  onMouseEnter={() => setTooltipWa(true)}
                  onMouseLeave={() => setTooltipWa(false)}
                  className="inline-flex items-center gap-2 px-8 py-4 rounded-xl font-bold text-white text-lg transition-all duration-200 transform hover:scale-105 active:scale-95"
                  style={{
                    backgroundColor: '#f97316',
      ...
      <a
        ...
        target="_blank"
        rel="noopener noreferrer"
        className="fixed bottom-6 right-6 flex items-center gap-3 transition-all duration-200 hover:scale-105 active:scale-95"
        style={{ zIndex: 35, textDecoration: 'none' }}
